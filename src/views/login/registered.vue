  ...
  <div class="container">
    ...
    <div class="content">
      <div class="topbox clearfix">
        ...
        <el-steps :active="active" style="margin-top: 50px;margin-bottom: 50px;">
          <el-step title="填写注册信息" icon="el-icon-edit"></el-step>
          <el-step title="验证注册信息" icon="el-icon-printer"></el-step>
              ...
              <div class="tentbox">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a id="avcode" href="javascript:{}"><img class="yzm" id="code" style="width: 100px; height: 40px;"
                          alt="" :src="randomCode" v-on:click="getRandomCode" /></a>
                    </td>
                  </tr>
                </tbody>
              </div>
              ...
              <div class="tentbox">
                <el-checkbox v-model="sureChecked">
                  ...
                  <el-dialog title="用户协议" :visible.sync="centerDialogVisible" width="100%" top="10px"
                    :lock-scroll="lockScroll" :fullscreen="fullscreen" center>
                    <div>
                      <p
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> 1、 本平台</span><span style="font-family:'等线'">台</span><span
                          style="font-family:'等线'">是国内最大，</span><span style="font-family:'等线'">最</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">第二部分</span><span style="font-family:'等线'"> 权利义务</span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> 2、</span><span style="font-family:'等线'">由于点卡的</span><span
                          style="font-family:'等线'">使用（包含神州行卡）都是一次性使用的，因此用户在销售过程请认真选择</span><span
                          style="font-family:'等线'">卡正确</span><span style="font-family:'等线'">的面值，如因用户自己提交错误面值造成的损失由您自己承担。
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                          5、用户应当保证在使用本网站网上交易平台进行交易过程中遵守本</span><span style="font-family:'等线'">站交易</span><span
                          style="font-family:'等线'">原则，所有</span><span style="font-family:'等线'">出售点卡的</span><span
                          style="font-family:'等线'">款项是直接划到</span><span style="font-family:'等线'">您交易</span><span
                          style="font-family:'等线'">的用户的</span><span style="font-family:'等线'">帐户</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （1）用户或</span><span style="font-family:'等线'">其他第三</span><span
                          style="font-family:'等线'">方通知本网站，认为某个具体用户或具体交易事项可能存在重大问题；</span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （2）用户或</span><span style="font-family:'等线'">其他第三</span><span
                          style="font-family:'等线'">方向本网站告知交易平台上有违法或不当行为的，本网站以普通非专业交易者的知识水平标准对相关内容进行判别，可以</span><span
                          style="font-family:'等线'">明显认为</span><span style="font-family:'等线'">这些内容或行为具有违法或不当性质的；</span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （2）注销或删除用户</span><span style="font-family:'等线'">帐户</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">第三部分</span><span style="font-family:'等线'"> 服务的中断和终止 </span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                          ...
                          随时终止用户的“服务”密码、</span><span style="font-family:'等线'">帐户</span><span style="font-family:'等线'">
                          ...
                          style="font-family:'等线'">终止后，本网站没有义务为您保留原</span><span style="font-family:'等线'">帐户</span><span
                      ...
                      <p
                        ...
                        <span style="font-family:'等线'">
                          ...
                          style="font-family:'等线'">后，本</span><span style="font-family:'等线'">网站仍</span><span
                          style="font-family:'等线'">保留下列权利：</span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                          （2）用户注销后，如用户在注销前在本网站交易平台上存在违法行为或违反合同的行为，本</span><span style="font-family:'等线'">网站仍</span><span
                          style="font-family:'等线'">可行使</span><span style="font-family:'等线'">本服务</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （1）在用户违反</span><span style="font-family:'等线'">本服务</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （5）</span><span style="font-family:'等线'">本服务</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                          （2）服务中断、终止之前，用户已经就其他用户出售的具体物品</span><span style="font-family:'等线'">作出</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">第四部分</span><span style="font-family:'等线'"> 责任范围 </span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （2）用户</span><span style="font-family:'等线'">因通过</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">第五部分</span><span style="font-family:'等线'"> 免责条款 </span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'"> （3） 因通信服务</span><span style="font-family:'等线'">提供业</span><span
                      ...
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">第六部分</span><span style="font-family:'等线'"> 知识产权保护 </span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">
                          ...
                          style="font-family:'等线'">括但不限于诉讼费用及律师费用等</span><span style="font-family:'等线'">)。</span>
                      </p>
                      <p
                        style="margin-top:0pt; margin-bottom:0pt; text-align:justify; widows:0; orphans:0; font-size:10.5pt">
                        <span style="font-family:'等线'">&nbsp;</span>
                      ...
                      <p
                        ...
                        <span style="font-family:'等线'">
                          ...
                          本协议取代用户和本公司先前就相同事项订立的任何书面或口头协议，本协议与本网站之</span><span style="font-family:'等线'">任何现在</span><span
      ...
      <div class="dialogbox">
        ...
        <div class="box">
          ...
          <p class="tc" v-for="(item, i) in serverQQ" :key="'qq' + i">
            <a v-for="(item, i) in serverQQ" :key="'qq' + i" class="service-qq" data-tooltip-title="点击联系客服" :href="'https://wpa.qq.com/msgrd?v=3&uin=' +
              item.qq +
              '&site=qq&menu=yes'
              " target="_blank">
            ...
            <!-- 客服QQ{{i}}：<a :href="'tencent://message/?uin=' + item.qq + '&Site=&Menu=yes'">{{ item.qq }}</a> -->
          </p>
        </div>
      </div>
    </div>
...
.banner {
  height: 280px;
  background: url(../../assets/images/banner21.png) no-repeat center
    center;
