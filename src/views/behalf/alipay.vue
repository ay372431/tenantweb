<template>
  <div class="wrap-box">
    <div class="sonbar"><img src="../../assets/img/san.png" />支付宝统计</div>
    <div class="wrap-box-c">
      <div class="fieldset">
        <el-divider content-position="left"
          ><span class="legend">支付宝统计</span></el-divider
        >
        <div class="search-box mgl15 mgb15">
          ...
          <div class="item  label  mgl10 ">收款账号：</div>
...
export default {
  ...
  methods: {
    async getLists() {
      ...
      api
        .get('/api/TenantPaid/AliPayStatistics', {
          headers: {
