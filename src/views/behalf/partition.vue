<template>
  <div class="wrap-box">
    <div class="sonbar"><img src="../../assets/img/san.png" />分区统计</div>
    <div class="wrap-box-c">
      <div class="fieldset">
        <el-divider content-position="left"
          ><span class="legend">分区统计</span></el-divider
        >
        <div class="search-box mgl15 mgb15">
          <div class="item  label  mgl10">开始时间：</div>
...
export default {
  ...
  methods: {
    async getLists() {
      ...
      api
        .get('/api/TenantPaid/PartitionStatistics', {
          headers: {
